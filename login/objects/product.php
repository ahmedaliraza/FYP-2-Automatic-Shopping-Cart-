...
class Product{
    ...
    public function saveTotal($amount,$cartID,$products){
        ...
        // posted values
        $this->rfid=htmlspecialchars(strip_tags($amount,$cartID,$products));
        
        // bind values 
        $stmt->bindParam(":amount,:cartID,:products",$amount,$cartID,$products);
