    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-left">
               <img src="images/logo.jpg" align="center" style="width:1100px;height:200px;"> 
                <h1 class="mt-5  border-bottom" style="color:black;border-style:solid;background-color:azure " align="center">PRODUCTS(DATABASE)</h1>
                <br />
                <div class="col-lg-12" style="border-style: solid;background-color:azure; ">
                <a href="profile.php" style="color:black; font:100px">&#8592;HOMEPAGE</a>
            </div>
<hr>
