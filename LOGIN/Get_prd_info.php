...
<html>
 <head>
  <title>SEARCH(PRD)-CARTIGO MANAGEMENT SYSTEM </title>  
...
<div id="flip" style="border:solid;background-color:lightblue" style="width:7in">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav" >
      ...
      <li ><a href="searchbill.php" style="color:blue">SEARCH_BILLS</a></li>
    </ul>
  </div>
</div>
</nav></div>
   ...
   <br>
      ...
      <form id="panel10" action="" method="POST">
       ...
       <ul><input type="" name="id" id="id" value="" class="form-control" required="" placeholder="ENTER PRODUCTS ID" style="width:4in">
  ...
  <table  align="center" border="2px" style="width: 1000px">
    <tr><th style="color:black" colspan="12"><h3 align="center"><b>PRODUCTS</b></h3></th>
         <tr>
                 <th><b>COOKING OILS(<a target="_blank" href="Cooking Oils.pdf">)</b></th>
                 <th><b>GHEE(<a target="_blank" href="ghee.pdf">)</b></th>
                 <th><b>CHOCOLATES(<a target="_blank" href="chocolates.pdf">)</b></th>
                 <th><b>SPORTS(<a target="_blank" href="sports.pdf">)</b></th>
                 <th><b>SOAPS(<a target="_blank" href="soap.pdf">)</b></th>
     <!--             <th><b>LAPTOPS</b></th> -->
<!--                  <th><b>MOBILES</b></th>
                 <th><b>DETERGENTS</b></th> -->
                 <th><b>SNACKS(<a target="_blank" href="snacks.pdf">)</a></b></th>
                 <th><b>BISCUITS(<a target="_blank" href="biscuits.pdf">)</b></th>
...
<!--        <div class="input_panel" style="background: transparent;background-color:lavender ">
       <ul><h4><b>PRODUCT_TYPE :</b></h4>
        ...
        <select id="id" name="id" required="" style="width: 10in;height: 0.25IN">
         <option value="--">--</option>
...
$sql = "SELECT * FROM products WHERE  `id`=$id && CONCAT(`id`, `name`,`rfid`, `price`)";
